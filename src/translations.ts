...
export const TRANSLATIONS: Record<Locale, TranslationKeys> = {
  en: {
    ...
    bankSelectLabel: "ምረጥ / Select Bank / Wallet",
    refInputLabel: "Reference / Receipt URL",
    bypassedIfQr: "Bypassed if QR used",
    refInputPlaceholder: "Reference Number or Receipt Link",
    accountSuffixLabel: "Account Suffix (Optional)",
    accountSuffixHelp: "Account Suffix",
    accountSuffixPlaceholder: "e.g., 54321 or 10002345",
  ...
  am: {
    ...
    bankSelectLabel: "ባንክ / የኪስ ቦርሳ ይምረጡ",
    refInputLabel: "ማጣቀሻ ቁጥር ወይም ደረሰኝ ሊንክ",
    bypassedIfQr: "በኪውአር ካለፉ መሙላት አይጠበቅብዎትም",
    refInputPlaceholder: "የማጣቀሻ ቁጥር ወይም የደረሰኝ ሊንክ ያስገቡ",
    accountSuffixLabel: "የሂሳብ ማጠቃለያ ቁጥር (አማራጭ)",
    accountSuffixHelp: "የሂሳብ ማጠቃለያ ቁጥር",
    accountSuffixPlaceholder: "ለምሳሌ: 54321 ወይም 10002345",
    ...
    phoneLabel: "የከፋይ ስልክ ቁጥር",
    phoneRequired: "(የግድ ነው)",
    phoneOptional: "(አማራጭ)",
    phonePlaceholder: "ለምሳሌ: 0912345678 ወይም 251912345678",
    phoneHelp: "ሲቢኢ ብር (CBE Birr) ግብይት ለማረጋገጥ የከፋዩን ስልክ ቁጥር ማስገባት ግዴታ ነው።",
    verifyBtn: "ግብይቱን አረጋግጥ",
